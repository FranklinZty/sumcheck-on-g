...
pub trait GroupSumCheck<G: CurveGroup> {
    type VirtualGroupPolynomial;
    type VPAuxInfo;
    type GroupMultilinearExtension;
    ...
    fn prove(
        poly: &Self::VirtualGroupPolynomial,
...
pub trait GroupSumCheckProver<G: CurveGroup>
where
    Self: Sized,
{
    type VirtualGroupPolynomial;
...
pub trait GroupSumCheckVerifier<G: CurveGroup> {
    type VPAuxInfo;
    type ProverMessage;
    type Challenge;
    type Transcript;
...
pub struct GroupSumCheckSubClaim<G:CurveGroup> {
...
impl<G: CurveGroup> GroupSumCheck<G> for PolyIOP<G::ScalarField> {
    ...
    fn init_transcript() -> Self::Transcript {
        ...
        let res = IOPTranscript::<G::ScalarField>::new(b"Initializing SumCheck transcript");
        end_timer!(start);
        res
    }
