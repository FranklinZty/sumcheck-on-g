...
mod tests {
    use super::*;
    use crate::{
        multilinear_polynomial::fix_variables,
        multilinear_polynomial::fix_last_variables,
        utils::{hypercube::BooleanHypercube, vec::to_F_matrix},
    };
    ...
    #[test]
    fn test_vec_to_mle() {
        let z = vec![Fr::from(1), Fr::from(2), Fr::from(3)];
        let n_vars = 3;
